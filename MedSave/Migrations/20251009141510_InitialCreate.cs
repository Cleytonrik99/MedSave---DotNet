        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    POS_USER_ID = table.Column<decimal>(type: "NUMBER(20,0)", nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
                    USER_POSITION = table.Column<string>(type: "VARCHAR2(100)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_POSITION_USER", x => x.POS_USER_ID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_POSITION_USER_USERS_SYS",
                        column: x => x.POS_USER_ID,
                        principalTable: "POSITION_USER",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ACTIVE_INGREDIENT_MEDICINES",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PHARMACEUTICAL_FORM_MEDICINES",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BATCH_ID = table.Column<decimal>(type: "NUMBER(20,0)", nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
                    BatchNumber = table.Column<string>(type: "NVARCHAR2(2000)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MEDICINE_DISPENSE_MOVEMENT_TYPE_ID",
                table: "MEDICINE_DISPENSE",
                column: "MOVEMENT_TYPE_ID");

            migrationBuilder.CreateIndex(
                name: "IX_MEDICINE_DISPENSE_STOCK_ID",
                table: "MEDICINE_DISPENSE",
                column: "STOCK_ID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MEDICINES_ACT_INGRE_ID",
                table: "MEDICINES",
                column: "ACT_INGRE_ID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MEDICINES_PHARM_FORM_ID",
                table: "MEDICINES",
