    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ROLE_USER_ID = table.Column<decimal>(type: "NUMBER(20,0)", nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.ROLE_USER_ID,
                        principalTable: "ROLE_USER",
                        principalColumn: "ROLE_USER_ID",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OBSERVATION = table.Column<string>(type: "VARCHAR2(255)", nullable: true),
                    USER_ID = table.Column<decimal>(type: "NUMBER(20,0)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_USERS_SYS_ROLE_USER_ID",
                table: "USERS_SYS",
                column: "ROLE_USER_ID");
