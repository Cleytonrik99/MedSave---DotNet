...
namespace MedSave.Migrations
{
    ...
    [Migration("20251009142322_SmallAdjustments")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MedSave.Model.ContactManufacturer", b =>
                {
                    ...
                    b.Property<long>("PhoneNumberManu")
            ...
            modelBuilder.Entity("MedSave.Model.PositionUser", b =>
                {
                    b.Property<decimal>("PosUserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("NUMBER")
                        .HasColumnName("POS_USER_ID");

                    OraclePropertyBuilderExtensions.UseIdentityColumn(b.Property<decimal>("PosUserId"));
                    ...
                    b.ToTable("POSITION_USER", (string)null);
                });
            ...
            modelBuilder.Entity("MedSave.Model.UsersSys", b =>
                {
                    ...
                    b.HasOne("MedSave.Model.PositionUser", "PositionUser")
                        .WithMany()
